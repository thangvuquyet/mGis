...
namespace mGISv3.Migrations
{
    ...
    [Migration("20231205142511_Add_FactHousings")]
    partial class Add_FactHousings
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("mGISv3.FactHousing.FactHousings", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("mGISv3.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("mGISv3.Authorization.Users.User", null)
                        .WithMany("Claims")
