...
{
    public abstract class mGISv3WebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static mGISv3WebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(mGISv3WebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<mGISv3DbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<mGISv3DbContext, Task> action)
        {
            using (var context = IocManager.Resolve<mGISv3DbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<mGISv3DbContext, Task<T>> func)
        {
            T result;
