...
@Injectable()
export class FactHousingServiceServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    get(id: string | undefined): Observable<FactHousingList> {
        let url_ = this.baseUrl + "/api/services/app/FactHousingService/Get?";
        if (id === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FactHousingList>><any>_observableThrow(e);
                }
            } else
                return <Observable<FactHousingList>><any>_observableThrow(response_);
        }));
    }

    protected processGet(response: HttpResponseBase): Observable<FactHousingList> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FactHousingList.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<FactHousingList>(<any>null);
    }
     ...
     * @return Success
     */
    getAll(sorting: string | undefined, skipCount: number | undefined, maxResultCount: number | undefined): Observable<FactHousingListPagedResultDto> {
        let url_ = this.baseUrl + "/api/services/app/FactHousingService/GetAll?";
        if (sorting === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<FactHousingListPagedResultDto>><any>_observableThrow(e);
                }
            } else
                return <Observable<FactHousingListPagedResultDto>><any>_observableThrow(response_);
        }));
    }

    protected processGetAll(response: HttpResponseBase): Observable<FactHousingListPagedResultDto> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = FactHousingListPagedResultDto.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status !== 200 && status !== 204) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<FactHousingListPagedResultDto>(<any>null);
    }
     ...
     * @return Success
     */
    create(body: FactHousingList | undefined): Observable<FactHousingList> {
        let url_ = this.baseUrl + "/api/services/app/FactHousingService/Create";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processCreate(response: HttpResponseBase): Observable<FactHousingList> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    update(body: FactHousingList | undefined): Observable<FactHousingList> {
        let url_ = this.baseUrl + "/api/services/app/FactHousingService/Update";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processUpdate(response: HttpResponseBase): Observable<FactHousingList> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    delete(id: string | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/FactHousingService/Delete?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
...
export class FactHousingList implements IFactHousingList {
    id: string;
    ...
    constructor(data?: IFactHousingList) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.houseTypeID = _data["houseTypeID"];
            this.certID = _data["certID"];
            this.floor = _data["floor"];
            this.no_Room = _data["no_Room"];
            this.area = _data["area"];
        }
    }

    static fromJS(data: any): FactHousingList {
        data = typeof data === 'object' ? data : {};
        let result = new FactHousingList();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["no_Room"] = this.no_Room;
        data["area"] = this.area;
        return data; 
    }

    clone(): FactHousingList {
        const json = this.toJSON();
        let result = new FactHousingList();
        result.init(json);
        return result;
...
export interface IFactHousingList {
    id: string;
    creationTime: moment.Moment;
    creatorUserId: number | undefined;
    lastModificationTime: moment.Moment | undefined;
...
export class FactHousingListPagedResultDto implements IFactHousingListPagedResultDto {
    items: FactHousingList[] | undefined;
    totalCount: number;

    constructor(data?: IFactHousingListPagedResultDto) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            if (Array.isArray(_data["items"])) {
                ...
                for (let item of _data["items"])
                    this.items.push(FactHousingList.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): FactHousingListPagedResultDto {
        data = typeof data === 'object' ? data : {};
        let result = new FactHousingListPagedResultDto();
        result.init(data);
        return result;
    }
    ...
    clone(): FactHousingListPagedResultDto {
        const json = this.toJSON();
        let result = new FactHousingListPagedResultDto();
        result.init(json);
        return result;
...
export interface IFactHousingListPagedResultDto {
    items: FactHousingList[] | undefined;
    totalCount: number;
}
